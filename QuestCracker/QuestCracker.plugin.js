...
module.exports = class QuestCracker {
    start() {
        BdApi.Logger.log("RunScript", "Plugin started");
...
if(quests.length === 0) {
	...
	doJob()
            ...
            BdApi.showToast("QuestCracker: Code executed", {
                type: "success",
                timeout: 3000
            });

        } catch (error) {
            BdApi.Logger.error("QuestCracker", error);
            BdApi.showToast("QuestCracker: Error", {
                type: "error",
                timeout: 5000
            });
        }
    ...
    stop() {
        BdApi.Logger.log("QuestCrackert", "Plugin stopped");
    }
};
